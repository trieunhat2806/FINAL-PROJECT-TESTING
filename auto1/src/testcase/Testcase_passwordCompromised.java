...
public class Testcase_passwordCompromised {
...
public void test() throws Exception {
	...
	//signup
			...
			//Password
			objSignUp.SignUp_Password("eeeeeeeeeeeeeeeeee");
			Reporter.log("password entered");
			
			//checkpoint
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			String actualText = objMsg.getMsgCompromised().trim().toLowerCase();
			Assert.assertTrue(actualText.matches(".*password may be compromised.*"), 
					"Text not found: Password may be compromised");
