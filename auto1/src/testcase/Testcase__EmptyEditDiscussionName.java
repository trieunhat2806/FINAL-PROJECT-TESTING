...
public class Testcase__EmptyEditDiscussionName {
...
@SuppressWarnings("deprecation")
	...
	public void test() throws Exception{
		...
		// EditDicussion Name
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		objGeneralDiscussion.EditEmptyDicusionName(TestName);
		Reporter.log("Name changed Fail");
		
		objGeneralDiscussion = new GeneralDiscussion(driver);

		System.out.println(objGeneralDiscussion.getEdit_empty());
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		String actualText = objGeneralDiscussion.getEdit_empty();

		Assert.assertTrue(actualText.matches(""));
		//Assert.assertTrue(actualText.matches("Title can't be blank"));
