...
public class Testcase_passwordNotSatisfy {
...
public void test() throws Exception {
	...
	//signup
			...
			//Password
			objSignUp.SignUp_Password("cccwwweef");
			Reporter.log("password entered");
			
			//checkpoint
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			String actualText = objMsg.getMsgSatisfy().trim().toLowerCase();
			Assert.assertTrue(actualText.matches(".*password needs a number and lowercase letter.*"), 
					"Text not found: Password needs a number and lowercase letter");
